...
├── .Codex/skills/              # 18 skills (loaded on demand)
...
Sync this folder to GitHub (private repo) to access via the Codex mobile app. Your `context-library/` files sync with it. Run any skill from your phone.

## Getting Started

1. Run: `Read AGENTS.md and summarize what this Job Search OS does`
