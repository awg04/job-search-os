...
- `/work-product Anthropic + PM Codex + specific-interview`
...
- `get-interview`: no additional input required (Codex runs research hooks)
...
**Codex runs these automated checks after drafting:**
