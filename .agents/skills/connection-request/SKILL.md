...
- LinkedIn search results or people list for gap companies. Since Codex cannot search LinkedIn directly, prompt the user with this exact template for each gap company:
...
After reading files, Codex identifies that Notion (Rank 3) has 1 connection, Figma (Rank 5) has 0, and Anthropic (Rank 1) has 2.
