...
- "Tell Me About Yourself" addressing: only 4 years PM experience (counter: built at startup scale), no AI/ML listed (counter: Codex projects, AI prototyping)
- Key stories mapped to Anthropic's priorities: developer tools experience, technical product work, 0-to-1 building
- Product areas to have opinions on: Codex roadmap, API pricing strategy, enterprise vs consumer focus
