...
### Gaps (2 partial-match requirements)
...
**BI & Reporting:** Power BI (Tabular Data Models, DAX), Power BI Report Builder, SSRS, Power Query, Tableau
**ETL / Data Engineering:** SSIS, Azure Data Factory, Azure Synapse Analytics, Microsoft Fabric (Lakehouse, Pipelines, Dataflows)
**Databases:** SQL Server, Azure SQL, Oracle, Snowflake, Databricks
**Languages:** SQL, T-SQL, DAX, Python
**Cloud:** Microsoft Azure
**Certifications (In Progress):** PL-300 Power BI Data Analyst Associate; DP-203 Azure Data Engineer Associate
...
**Earlier:** Financial Advisor, Merrill Lynch (2009–2016) — co-managed $250M in client assets; built foundational financial reporting expertise (P&L, Balance Sheet, Cash Flow) that underpins current BI/data engineering work.

**Education**

BS, Finance & Economics — Florida State University
...
**Keyword Coverage**
**Required skills:** 10/12 matched in-context (83%)
**Preferred/implied skills:** Tableau matched via skills list only (no bullet uses it in context — flag below)

| JD Keyword | Found in Resume? | Location | Notes |
|------------|-----------------|----------|-------|
| SSIS | Yes | Twin-Star bullet 1 | Exact match |
| Tabular Data Models / Power BI | Yes | Carnival bullet 3, Summary | Exact match |
| Tableau | Partial | Skills list only | Not used in any bullet — JD accepts "Tableau OR Power BI" so Power BI alone satisfies this; leaving Tableau in skills is honest but unproven |
| ETL / ELT | Yes | Multiple bullets, all roles | Exact match |
| Data mart / data warehouse | Yes | Basic Fun bullet 1, Twin-Star bullet 1 | Exact match |
| Performance tuning | Yes | Carnival bullet 2, Basic Fun bullet 3 | Exact match |
| Production troubleshooting | Yes | Carnival bullet 2, Basic Fun bullet 3 | Exact match |
| SQL Server | Yes | Twin-Star bullet 2, Skills | Exact match |
...
2. **Developing new APIs** - In experience library: No. Flag as genuine gap. Address in cover letter (see Gaps table). Do not add to resume bullets.
...
| "Used Azure Synapse Analytics to schedule, orchestrate..." | Data Engineering & ETL | "Used Azure Synapse Analytics to schedule, orchestrate, and automate ETL tasks at Carnival..." | EXACT |
